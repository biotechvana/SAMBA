      ...
      shinydashboardPlus::dashboardPage(
        ...
        dashboardHeader(
          ...
          tags$li(class = "dropdown", actionButton(
            ...
            style =
              "background-color: transparent;border-color: transparent;font-size: 24px;"
          )),
          tags$li(class = "dropdown", actionButton(
            inputId = "Capture", label = "",
            ...
            sidebarMenu(
              ...
              menuItem("Nodes",
                ...
                menuItem("Shape and size",
                  ...
                  conditionalPanel(
                    ...
                    radioButtons(
                      inputId = "N_autosize_type", label = "Set nodes size acording to the number of:",
                      choices = list("All connected edges" = "C_E", "Edges from the node" = "E_F", "Edges to the node" = "E_T"),
                      selected = "C_E"
                    ),
                    sliderInput(
                      inputId = "N_size_range", "Size range:",
                  ...
                  conditionalPanel(
                    ...
                    sliderInput(
                      inputId = "N_size", label = "Size",
                      min = 10, max = 100, value = DT$size
                    )
                  ),
                  sliderInput(
                    inputId = "N_borderWidth", label = "Border Width",
                ...
                menuItem("Color",
                  ...
                  fixedRow(
                    column(4, br(), tags$p("Fill")),
                    column(8, colourInput(
                      inputId = "N_color_highlight_background",
                  ...
                  fixedRow(
                    column(4, br(), tags$p("Border")),
                    column(8, colourInput(
                      inputId = "N_color_highlight_border",
                      label = NULL, value = DT$color_border
                    ))
                  ),
                  # HTML("<hr>"),
                ...
                menuItem("Labels",
                  ...
                  # Fondo
                  sliderInput(
                    inputId = "N_label_strokeWidth", label = "Background width",
                ...
                menuItem("Shadow",
                  ...
                  fluidRow(
                    ...
                    shiny::conditionalPanel(
                      ...
                      sliderInput(
                        inputId = "N_shadow_x", label = "X",
                        min = -25, max = 25, value = DT$shadow_x
                      ),
                      sliderInput(
                        inputId = "N_shadow_y", label = "Y",
              ...
              menuItem("Edges",
                ...
                menuItem("Labels",
                  ...
                  # Tamaño
                  sliderInput(
                    inputId = "E_label_size", label = "Size",
                  ...
                  # Fondo
                  sliderInput(
                    inputId = "E_label_strokeWidth", label = "Background",
                    min = 0, max = 100, value = DT$font_strokeWidth
                  ),
                  # Fondo color
                  fixedRow(
                ...
                menuItem("Shadow",
                  ...
                  fluidRow(
                    ...
                    shiny::conditionalPanel(
                      ...
                      sliderInput(
                        inputId = "E_shadow_x", label = "X",
                        min = -25, max = 25, value = DT$shadow_x
                      ),
                      sliderInput(
                        inputId = "E_shadow_y", label = "Y",
                        min = -25, max = 25, value = DT$shadow_y
                      )
                    )
                  )
            ...
            tabBox(
              ...
              tabPanel(
                ...
                fluidRow(
                  column(
                    width = 8,
                    checkboxGroupInput(
                      inputId = "Filter_Tab_N", label = "Select an option to emphasize or show only selected nodes",
              ...
              tabPanel(
                ...
                column(
                  width = 8,
                  checkboxGroupInput(
                    inputId = "Filter_Tab_E", label = "Select an option to emphasize or show only selected nodes",
                    choices = list("Emphasize" = "Emph", "Show/Hide" = "S/H"), selected = NULL,
                    width = "100%"
                  )
                ),
          ...
          bsModal(
            ...
            fluidRow(
              column(
                4,
                textInput(
                  inputId = "Out_name", label = "File name",
                  value = "Output"
                )
              ),
